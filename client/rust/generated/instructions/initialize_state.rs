...
use crate::generated::types::InitializeMyStateIxData;
...
impl InitializeState {
  pub fn instruction(&self, args: InitializeStateInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeStateInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeStateInstructionArgs {
                  pub initialize_my_state_ix_data: InitializeMyStateIxData,
      }
...
pub struct InitializeStateBuilder {
            payer_acc: Option<solana_pubkey::Pubkey>,
                ...
                system_program_acc: Option<solana_pubkey::Pubkey>,
                        initialize_my_state_ix_data: Option<InitializeMyStateIxData>,
...
#[inline(always)]
    pub fn system_program_acc(&mut self, system_program_acc: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn initialize_my_state_ix_data(&mut self, initialize_my_state_ix_data: InitializeMyStateIxData) -> &mut Self {
        self.initialize_my_state_ix_data = Some(initialize_my_state_ix_data);
        self
      }
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = InitializeState {
                              payer_acc: self.payer_acc.expect("payer_acc is not set"),
                                        ...
                                        system_program_acc: self.system_program_acc.expect("system_program_acc is not set"),
                      };
          let args = InitializeStateInstructionArgs {
                                                              initialize_my_state_ix_data: self.initialize_my_state_ix_data.clone().expect("initialize_my_state_ix_data is not set"),
                                    };
    ...
    let instruction = Box::new(InitializeStateCpiBuilderInstruction {
      __program: program,
              ...
              system_program_acc: None,
                                            initialize_my_state_ix_data: None,
...
#[inline(always)]
    pub fn state_acc(&mut self, state_acc: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Sysvar rent account
#[inline(always)]
    pub fn sysvar_rent_acc(&mut self, sysvar_rent_acc: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.sysvar_rent_acc = Some(sysvar_rent_acc);
                    self
    }
      /// System program account
#[inline(always)]
    pub fn system_program_acc(&mut self, system_program_acc: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.system_program_acc = Some(system_program_acc);
                    self
    }
                    #[inline(always)]
      pub fn initialize_my_state_ix_data(&mut self, initialize_my_state_ix_data: InitializeMyStateIxData) -> &mut Self {
        self.instruction.initialize_my_state_ix_data = Some(initialize_my_state_ix_data);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = InitializeStateInstructionArgs {
                                                              initialize_my_state_ix_data: self.instruction.initialize_my_state_ix_data.clone().expect("initialize_my_state_ix_data is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          sysvar_rent_acc: self.instruction.sysvar_rent_acc.expect("sysvar_rent_acc is not set"),
                  
          system_program_acc: self.instruction.system_program_acc.expect("system_program_acc is not set"),
                          __args: args,
            };
